...
android {
    namespace = "com.example.proyecto_notas"
    compileSdk = 34
...
dependencies {
    ...
    val material3Window = "1.1.0-alpha06"
    val room_v = "2.5.0"
    implementation ("androidx.navigation:navigation-compose:$nav_version")
    implementation("androidx.compose.material3:material3:$material3")
    implementation("androidx.compose.material3:material3-window-size-class:$material3Window")
